...
export default {
  ...
  // 'Append Task': '添加任务',
  'Append Task': 'Append processing node',
  ...
  'Connect using Sequence/MessageFlow or Association': 'Sequentially connect nodes',
  ...
  'Create Intermediate/Boundary Event': 'The supplementary data of intermediate processing nodes',
  ...
  'Create StartEvent': 'The input data of the first processing nodes',
  // 'Create EndEvent': '结束节点',
  'Create EndEvent': 'The output data of the last nodes',
  'Create ExclusiveGateway': '互斥网关',
  'Create ParallelGateway': '并行网关',
  // 'Create Task': '任务节点',
  'Create Task': 'Abstract processing services that contain processing capabilities',
  ...
  'Append EndEvent': 'Append result node',
  'Append Gateway': '追加网关节点',
  // 'Append UserTask': '追加用户任务节点',
  'Append UserTask': 'Append processing node',
  // 'Append Intermediate/Boundary Event': '追加中间或边界事件',
  'Append Intermediate/Boundary Event': 'Append intermediate data node',
